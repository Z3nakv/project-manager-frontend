  ...
  if (data)
    return (
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex gap-3">
            <button
              ...
              className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-500 text-white text-sm font-semibold px-4 py-2.5 rounded-xl transition-colors duration-150 shadow-md shadow-indigo-500/20 cursor-pointer"
            >
        ...
        {/* Team list */}
        <div className="bg-[#1e2330] border border-[#2d3348] rounded-2xl shadow-[0_8px_24px_rgba(0,0,0,0.4)] overflow-hidden">
          <div className="flex items-center gap-2 px-6 py-4 border-b border-[#2d3348]">
          ...
          {data.length ? (
            <ul>
              {data.map((member, index) => (
                <li
                  key={member._id}
                  className={`flex items-center justify-between px-6 py-4 ${index !== data.length - 1 ? "border-b border-[#2d3348]" : ""}`}
                >
                  ...
                  <Menu as="div" className="relative flex-none">
                    ...
                    >
                      <MenuItems className="absolute right-10 bottom-0 z-10 min-w-44 rounded-xl overflow-hidden border border-[#2d3348] bg-[#252d3d] shadow-[0_8px_24px_rgba(0,0,0,0.4)] focus:outline-none">
                        <MenuItem>
                          <button
                            type="button"
                            onClick={() =>
