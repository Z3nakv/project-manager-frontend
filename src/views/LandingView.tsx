    ...
    <div className="min-h-screen bg-[#0a0e17] text-slate-200">
      ...
      <section className="text-center px-6 py-20 max-w-3xl mx-auto">
        ...
        <p className="text-slate-400 text-lg leading-relaxed max-w-xl mx-auto mb-8">
          Un tablero Kanban colaborativo con notificaciones en tiempo real,
          roles de equipo y seguimiento de tareas — todo en un solo lugar.
        </p>
      ...
      <div className="max-w-4xl mx-auto px-6 mb-20">
        <div className="bg-[#111827] border border-[#1e2330] rounded-2xl p-6 overflow-x-auto">
          <div className="flex items-center gap-2 mb-5">
            ...
            <span className="ml-2 text-xs text-slate-500 font-semibold uppercase tracking-wider">
            ...
            {[
              ...
              <div key={col.label} className="w-48 shrink-0">
                ...
                {col.tasks.map((task) => (
                  <div
                    key={task.name}
                    className="bg-[#1e2330] border border-[#2d3348] rounded-xl p-3 mb-2"
                  >
                    ...
                    {task.badge && (
                      <span
                        className={`inline-block text-[9px] font-bold px-2 py-0.5 rounded-full mt-2 uppercase tracking-wide ${task.badgeColor}`}
                      >
                        {task.badge}
                      </span>
                    )}
      ...
      <section className="px-6 py-16 max-w-5xl mx-auto">
        ...
        <p className="text-slate-500 mb-10 max-w-lg">
          Construido para equipos que trabajan rápido y necesitan visibilidad
          total del proyecto.
        </p>
          ...
          {[
            {
              ...
              desc: "Arrastra tareas entre columnas con drag & drop. Visualiza el flujo de trabajo.",
            },
            {
              icon: "⚡",
              color: "bg-amber-500/10",
              title: "Tiempo real",
              desc: "Los cambios se reflejan al instante para todos los miembros via Socket.io.",
            },
            {
              icon: "👥",
            ...
            },
            {
              ...
              desc: "Agrega contexto directamente en cada tarea con historial de cambios.",
            },
          ].map((f) => (
            <div
              key={f.title}
              className="bg-[#111827] border border-[#1e2330] hover:border-indigo-500/30 rounded-2xl p-6 transition-colors"
            >
              <div
                className={`w-10 h-10 rounded-xl ${f.color} flex items-center justify-center text-lg mb-4`}
              >
                {f.icon}
              </div>
        ...
        <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-10 items-center">
          <div className="flex-1">
            ...
            <h2 className="text-2xl sm:text-3xl font-extrabold tracking-tight mb-4">
              Tu equipo siempre sincronizado
            </h2>
            <p className="text-slate-500 leading-relaxed">
              Cuando alguien mueve una tarea, todos lo ven al instante. Sin
            ...
            {[
              {
                ...
                text: 'Adrian movió "Checkout flow" a En revisión',
                time: "ahora",
                unread: true,
              },
              {
      ...
      <section className="text-center px-6 py-24">
        ...
        <p className="text-slate-500 mb-8 max-w-md mx-auto">
          Sin tarjeta de crédito. Sin límites en proyectos. Solo tú y tu equipo
          trabajando mejor.
        </p>
        <Link
          to="/auth/register"
